...
def main():
    ...
    parser.add_argument('--organism', '-o', type=str, required=False, choices=supported_organisms, help=f"Organism to interpret. Must be one of: {', '.join(supported_organisms)}")
